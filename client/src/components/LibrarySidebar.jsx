...
import { BookMarked, BookOpen, Globe, Home, Search, Users } from 'lucide-react';

const items = [
  { to: '/library', label: 'Dashboard', Icon: Home },
  { to: '/library/books', label: 'Books', Icon: BookOpen },
  { to: '/library/search', label: 'Search', Icon: Search },
  { to: '/library/study-rooms', label: 'Study Rooms', Icon: Users },
  { to: '/library/digital-resources', label: 'Digital Resources', Icon: Globe },
  { to: '/library/my-library', label: 'My Library', Icon: BookMarked },
];
