          ...
          <div className="p-8 md:p-10 bg-white/80 backdrop-blur-xl">
            ...
            <div className="mt-8">
              ...
              <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                >
                  ...
                  <div className="mt-1 text-xs text-gray-500">Upload and manage resources</div>
                </Link>
                <Link
                  className="rounded-2xl border border-gray-200 bg-white px-4 py-4 text-left hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-200 transition-colors"
                  to="/admin/hostel"
                >
                  ...
                  <div className="mt-1 text-xs text-gray-500">Warden, laundry, meals shop</div>
                </Link>
                <Link
                  className="rounded-2xl border border-gray-200 bg-white px-4 py-4 text-left hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-200 transition-colors"
                ...
                >
                  ...
                  <div className="mt-1 text-xs text-gray-500">Books, borrowing, notices</div>
                </Link>
                <Link
                  className="rounded-2xl border border-gray-200 bg-white px-4 py-4 text-left hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-200 transition-colors"
                ...
                >
                  ...
                  <div className="mt-1 text-xs text-gray-500">Events and announcements</div>
                </Link>
              </div>
            </div>
            ...
            <div className="mt-8 pt-6 border-t border-gray-200 text-center">
              <p className="text-gray-500 text-sm">
                Student login?{' '}
                <Link className="font-semibold text-blue-600 hover:underline" to="/signin">
                  Sign in
                </Link>
              </p>
            </div>
